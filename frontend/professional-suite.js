(function () {
  ...
  function patchCardPrint() {
    ...
    window.printEmployeeCard = function (employeeId) {
      ...
      w.document.write('<html><head><title>Carteirinha NR</title><link rel="stylesheet" href="/pro-dashboard.css"><link rel="stylesheet" href="/pro-polish.css"><link rel="stylesheet" href="/nr-idcards.css"><link rel="stylesheet" href="/professional-suite.css"><style>@page{size:A4 landscape;margin:8mm}body{background:#fff;padding:0}.print-area{display:grid;place-items:center}.nr-wallet-set{grid-template-columns:1fr 1fr;gap:14px;transform:scale(.88);transform-origin:top center}.nr-id-card{box-shadow:none!important}.nr-actions,.nr-side-label{display:none!important}</style></head><body><div class="print-area">' + set.outerHTML + '</div><script>setTimeout(function(){window.print();window.close()},650)</script></body></html>');
      w.document.close();
    };
